...
public class Main {
    ...
    private static HashMap<String, ArrayList<Service>> createTour() {
        ...
        Service tour4 = new Tour( ServiceType.SEASIDE_HOLIDAYS, "Hostel", "Bus", "room only", 350, 7, "Greece" );
        ...
        Service tour20 = new Tour( ServiceType.GUIDED_TOUR, "Three star hotel", "Bus", "room only", 579, 7, "Belarus" );
        ...
        Service tour24 = new Tour( ServiceType.SHOPPING_TOUR, "Three star hotel", "air", "room only", 279, 4, "Italy" );
    ...
    private static void sellTour(HashMap<String, ArrayList<Service>> tourAndService) {
